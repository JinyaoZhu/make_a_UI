...
public class Server : MonoBehaviour {
    ...
    private void Tank1Init(Component component, GameObject model_3d) {
        ...
        component.buttonsIsActive = new bool[] { true, false, false, false, false, false };
        component.buttonsState = new bool[] { true, false, false, false, false, false };
        component.buttonsName = new string[] { "FN1", "NULL", "NULL", "NULL","","" };
    ...
    private void Tank2Init(Component component, GameObject model_3d)
    {
        ...
        component.buttonsIsActive = new bool[] { true, true, true, true, false, false };
        component.buttonsState = new bool[] { true, true, true, false, false, false };
        component.buttonsName = new string[] { "FN1", "FN2", "FN3", "FN4","","" };
    ...
    private void Ventil1Init(Component component, GameObject model_3d)
    {
        ...
        component.id = "V001";
        component.status = "Normal";
        component.buttonsIsActive = new bool[] { false, false, false, false, false, false };
        component.buttonsState = new bool[] { false, false, false, false, false, false };
    ...
    private void Mischer1Init(Component component, GameObject model_3d)
    {
        ...
        component.buttonsIsActive = new bool[] { true, true, true, true, true, true };
        component.buttonsState = new bool[] { true, false, false, false, true, false };
        component.buttonsName = new string[] { "Heating", "Cooling", "FN1", "FN2", "FN3", "FN4" };
        component.valueBarsIsActive = new bool[] { true, true };
    ...
    private void Pumpe1Init(Component component, GameObject model_3d)
    {
        ...
        component.status = "Normal";
        component.buttonsIsActive = new bool[] { true, true, true, true, false, false };
        component.buttonsState = new bool[] { true, false, true, false, false, false };
        component.buttonsName = new string[] { "FN1", "FN2", "FN3", "FN4", "", "" };
        component.valueBarsIsActive = new bool[] { true, false };
